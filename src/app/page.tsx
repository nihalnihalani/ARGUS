        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight mb-4">
              See the threat landscape in real time
            </h2>
            <p className="text-[15px] text-[#64748b] max-w-lg mx-auto mb-10">
              Launch the ARGUS dashboard to explore the live knowledge graph,
              global attack map, and AI-powered threat briefings.
            </p>

            <Link
              href="/dashboard"
              className="group inline-flex items-center gap-3 px-8 py-4 rounded-xl text-[15px] font-semibold text-black transition-all duration-300 hover:shadow-[0_0_48px_rgba(255,255,255,0.12)]"
